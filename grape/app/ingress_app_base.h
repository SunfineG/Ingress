...
class IterateKernel {
 public:
  ...
  virtual bool aggregate(value_t& a, value_t b) = 0;

  virtual z3::expr aggregate_z3(z3::expr a, z3::expr b) = 0;

  virtual bool update(value_t& a, value_t b) = 0;

  virtual value_t generate(value_t v, value_t m, value_t w) = 0;

  virtual z3::expr generate_z3(z3::solver& s, z3::expr b) = 0;
